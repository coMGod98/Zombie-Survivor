...
public class UIManager : MonoBehaviour
{
    ...
    private void UpdateUI()
    {
        ...
        expSlider.value = player.curExp / player.playerData.maxExp[player.level];
    ...
    public void ShowLevelUP(List<UpgradeType> upgradeOptions)
    {
        ...
        for (int i = 0; i < upgradeOptions.Count; i++)
        {
            ...
            {
                GameWorld.Instance.PlayerManager.previousSelectedUpgradeTypes.Add(upgradeType);
                GameWorld.Instance.PlayerManager.player.upgradeSelectionCounts[upgradeType]++;
